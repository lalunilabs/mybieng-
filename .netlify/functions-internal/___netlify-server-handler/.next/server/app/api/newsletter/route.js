"use strict";(()=>{var e={};e.id=5497,e.ids=[5497],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},84770:e=>{e.exports=require("crypto")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},68621:e=>{e.exports=require("punycode")},76162:e=>{e.exports=require("stream")},17360:e=>{e.exports=require("url")},71568:e=>{e.exports=require("zlib")},91014:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>f,patchFetch:()=>y,requestAsyncStorage:()=>g,routeModule:()=>p,serverHooks:()=>h,staticGenerationAsyncStorage:()=>m});var r={};i.r(r),i.d(r,{GET:()=>u,POST:()=>d});var a=i(49303),s=i(88716),o=i(60670),n=i(87070),l=i(24544),c=i(36119);async function d(e){try{let{email:t}=await e.json();if(!t||"string"!=typeof t)return n.NextResponse.json({error:"Valid email is required"},{status:400});if(!/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(t))return n.NextResponse.json({error:"Invalid email format"},{status:400});let i=t.toLowerCase().trim(),r="true"===(process.env.NEWSLETTER_DOUBLE_OPT_IN||"").toLowerCase(),a=await l.k.getNewsletterSubscriptionByEmail(i);if(a&&a.active)return n.NextResponse.json({message:"Already subscribed!",confirmed:!0},{status:200});if(r)return await l.k.upsertNewsletterSubscription({email:i,active:!1,subscribed_at:new Date().toISOString()}),(0,c.Gk)(i).then(e=>{e||console.warn("Confirmation email not sent (provider disabled or failed):",i)}).catch(e=>console.warn("Confirmation email threw unexpectedly:",e)),n.NextResponse.json({message:"Please check your email to confirm your subscription.",confirmed:!1},{status:201});return a&&!a.active?await l.k.activateNewsletterSubscriptionByEmail(i):await l.k.upsertNewsletterSubscription({email:i,active:!0,subscribed_at:new Date().toISOString()}),(0,c.QO)(i).then(e=>{e||console.warn("Welcome email not sent (provider disabled or failed):",i)}).catch(e=>console.warn("Welcome email threw unexpectedly:",e)),n.NextResponse.json({message:"Successfully subscribed!",confirmed:!0},{status:201})}catch(e){return n.NextResponse.json({error:"Failed to subscribe"},{status:500})}}async function u(e){try{let e=await l.k.getNewsletterSubscriptions();return n.NextResponse.json({success:!0,data:e,count:e.length})}catch(e){return n.NextResponse.json({error:"Failed to fetch subscriptions"},{status:500})}}let p=new a.AppRouteRouteModule({definition:{kind:s.x.APP_ROUTE,page:"/api/newsletter/route",pathname:"/api/newsletter",filename:"route",bundlePath:"app/api/newsletter/route"},resolvedPagePath:"/Users/niharikasai/mybeing/app/api/newsletter/route.ts",nextConfigOutput:"standalone",userland:r}),{requestAsyncStorage:g,staticGenerationAsyncStorage:m,serverHooks:h}=p,f="/api/newsletter/route";function y(){return(0,o.patchFetch)({serverHooks:h,staticGenerationAsyncStorage:m})}},24544:(e,t,i)=>{i.d(t,{k:()=>n});var r=i(69498),a=i(58177);process.env.SUPABASE_URL,process.env.SUPABASE_ANON_KEY;let s=(0,r.eI)(process.env.SUPABASE_URL||"https://placeholder.supabase.co",process.env.SUPABASE_ANON_KEY||"placeholder-key"),o=()=>process.env.SUPABASE_URL&&process.env.SUPABASE_ANON_KEY&&"https://your-project.supabase.co"!==process.env.SUPABASE_URL&&"your-supabase-anon-key"!==process.env.SUPABASE_ANON_KEY;class n{static async getAllBlogs(e=!1){if(!o())return a.QF.filter(t=>e||t.published);let t=s.from("blog_posts").select("*");e||(t=t.eq("published",!0));let{data:i,error:r}=await t.order("updated_at",{ascending:!1});if(r)throw r;return i}static async getBlogBySlug(e){if(!o())return a.QF.find(t=>t.slug===e)||null;let{data:t,error:i}=await s.from("blog_posts").select("*").eq("slug",e).single();if(i)throw i;return t}static async createBlog(e){let{data:t,error:i}=await s.from("blog_posts").insert(e).select().single();if(i)throw i;return t}static async updateBlog(e,t){let{data:i,error:r}=await s.from("blog_posts").update({...t,updated_at:new Date().toISOString()}).eq("id",e).select().single();if(r)throw r;return i}static async deleteBlog(e){let{error:t}=await s.from("blog_posts").delete().eq("id",e);if(t)throw t;return!0}static async getAllQuizzes(e=!1){if(!o())return a.RI.filter(t=>e||t.published);let t=s.from("quizzes").select("*");e||(t=t.eq("published",!0));let{data:i,error:r}=await t.order("updated_at",{ascending:!1});if(r)throw r;return i}static async getQuizBySlug(e){if(!o())return a.RI.find(t=>t.slug===e&&t.published)||null;let{data:t,error:i}=await s.from("quizzes").select("*").eq("slug",e).eq("published",!0).single();if(i)throw i;return t}static async createQuiz(e){let{data:t,error:i}=await s.from("quizzes").insert({...e,responses:0}).select().single();if(i)throw i;return t}static async updateQuiz(e,t){let{data:i,error:r}=await s.from("quizzes").update({...t,updated_at:new Date().toISOString()}).eq("id",e).select().single();if(r)throw r;return i}static async deleteQuiz(e){let{error:t}=await s.from("quizzes").delete().eq("id",e);if(t)throw t;return!0}static async getAllFeedback(){if(!o())return[];let{data:e,error:t}=await s.from("user_feedback").select("*").order("created_at",{ascending:!1});if(t)throw t;return e||[]}static async getFeedbackForQuiz(e){let{data:t,error:i}=await s.from("user_feedback").select("*").eq("quiz_id",e).order("created_at",{ascending:!1});if(i)throw i;return t}static async addFeedback(e){let{data:t,error:i}=await s.from("user_feedback").insert(e).select().single();if(i)throw i;return t}static async deleteFeedback(e){let{error:t}=await s.from("user_feedback").delete().eq("id",e);if(t)throw t;return!0}static async saveQuizResponse(e){let{data:t,error:i}=await s.from("quiz_responses").insert(e).select().single();if(i)throw i;return await s.rpc("increment_quiz_responses",{quiz_slug:e.quiz_slug}),t}static async getQuizAnalytics(e){let t=s.from("quiz_responses").select("*");e&&(t=t.eq("quiz_slug",e));let{data:i,error:r}=await t.order("completed_at",{ascending:!1});if(r)throw r;return i}static async createNewsletterSubscription(e){if(!o())return{id:Date.now().toString(),...e};let{data:t,error:i}=await s.from("newsletter_subscriptions").insert([e]).select().single();if(i)throw i;return t}static async getNewsletterSubscriptionByEmail(e){if(!o())return null;let t=e.toLowerCase().trim(),{data:i,error:r}=await s.from("newsletter_subscriptions").select("*").eq("email",t).limit(1).maybeSingle();if(r&&"PGRST116"!==r.code)throw r;return i||null}static async upsertNewsletterSubscription(e){if(!o())return{id:Date.now().toString(),subscribed_at:new Date().toISOString(),active:!!e.active,email:e.email};let t={email:e.email.toLowerCase().trim(),subscribed_at:e.subscribed_at||new Date().toISOString(),active:e.active??!0},{data:i,error:r}=await s.from("newsletter_subscriptions").upsert(t,{onConflict:"email"}).select().single();if(r)throw r;return i}static async getNewsletterSubscriptions(){if(!o())return[];let{data:e,error:t}=await s.from("newsletter_subscriptions").select("*").eq("active",!0).order("subscribed_at",{ascending:!1});if(t)throw t;return e||[]}static async deactivateNewsletterSubscriptionByEmail(e){if(!o())return!0;let t=e.toLowerCase().trim(),{error:i}=await s.from("newsletter_subscriptions").update({active:!1}).eq("email",t);if(i)throw i;return!0}static async activateNewsletterSubscriptionByEmail(e){if(!o())return!0;let t=e.toLowerCase().trim(),{error:i}=await s.from("newsletter_subscriptions").update({active:!0,subscribed_at:new Date().toISOString()}).eq("email",t);if(i)throw i;return!0}}},36119:(e,t,i)=>{i.d(t,{Gk:()=>o,QO:()=>s,_W:()=>d,gx:()=>a});var r=i(36522);async function a(e){try{let{subject:t,html:i,text:r}=function(e){let{analysis:t,quizTitle:i,completedAt:r}=e,a=`Your ${i} Results - MyBeing Self-Discovery`,s=`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8">

"use strict";(()=>{var e={};e.id=2090,e.ids=[2090],e.modules={20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},53379:(e,t,i)=>{i.r(t),i.d(t,{originalPathname:()=>g,patchFetch:()=>y,requestAsyncStorage:()=>m,routeModule:()=>d,serverHooks:()=>p,staticGenerationAsyncStorage:()=>h});var n={};i.r(n),i.d(n,{POST:()=>c});var s=i(49303),r=i(88716),o=i(60670),a=i(87070),u=i(86287),l=i(18147);async function c(e){try{let{email:t,articleId:i,action:n}=await e.json();if(!t||!i||!n)return a.NextResponse.json({error:"Missing required fields"},{status:400});let s=!1;if("like"===n?s=(0,u.HA)(t,i):"unlike"===n&&(s=(0,u.C2)(t,i)),s){let e=l.Z.find(e=>e.id===i);e&&("like"===n?e.likes=(e.likes||0)+1:e.likes=Math.max(0,(e.likes||0)-1))}return a.NextResponse.json({success:s})}catch(e){return console.error("Blog like API error:",e),a.NextResponse.json({error:"Internal server error"},{status:500})}}let d=new s.AppRouteRouteModule({definition:{kind:r.x.APP_ROUTE,page:"/api/blog/like/route",pathname:"/api/blog/like",filename:"route",bundlePath:"app/api/blog/like/route"},resolvedPagePath:"/Users/niharikasai/mybeing/app/api/blog/like/route.ts",nextConfigOutput:"standalone",userland:n}),{requestAsyncStorage:m,staticGenerationAsyncStorage:h,serverHooks:p}=d,g="/api/blog/like/route";function y(){return(0,o.patchFetch)({serverHooks:p,staticGenerationAsyncStorage:h})}},18147:(e,t,i)=>{i.d(t,{Z:()=>s,r:()=>r});var n=i(47090);let s=[{id:"1",title:"The Mental Tug-of-War: Understanding Cognitive Dissonance",slug:"mental-tug-of-war-cognitive-dissonance",excerpt:"Why our minds justify contradictions—and how to spot and resolve the tension.",content:`Cognitive dissonance is the discomfort we feel when our actions and values don't line up.
...
**[Start Your First Assessment](/quizzes) | [Subscribe for $${n.$.monthly}/month](/pricing) | [Chat with AI Now](/chat)**`,author:"MyBeing Research Team",publishedAt:new Date("2025-09-04"),tags:["ai","self-discovery","technology","personalization"],readTime:12,published:!0,likes:0,isPremium:!1,metaTitle:`MyBeing AI: Your Personal Self-Discovery Companion | $${n.$.monthly}/month Premium Plan`,metaDescription:`Discover how MyBeing AI transforms self-discovery with intelligent quiz analysis, personalized recommendations, and a $${n.$.monthly}/month premium plan including 2 free quizzes and 3 premium articles.`,keywords:["AI assistant","self-discovery","quiz analysis","personalized recommendations","personal growth","psychology AI","behavioral insights",`$${n.$.monthly} subscription`],ogImage:"/images/blog/mybeing-ai-companion.jpg"}];function r(e){return s.find(t=>t.slug===e)}},47090:(e,t,i)=>{i.d(t,{$:()=>n});let n={monthly:32,currency:"USD",features:["Audio versions of all articles (listen instead of read)","1 premium quiz/month (worth up to $50) - FREE","Subscriber-only articles & quizzes","Subscriber discounts on additional premium content","Ad-free experience","Progress tracking & personalized insights","Unlimited AI conversations"]}},86287:(e,t,i)=>{i.d(t,{C2:()=>w,EO:()=>k,ER:()=>x,F3:()=>A,F6:()=>h,FR:()=>p,HA:()=>v,XW:()=>l,Xt:()=>y,Z1:()=>b,cv:()=>m,gL:()=>f,m2:()=>P,qZ:()=>g,rz:()=>d,vQ:()=>z});let n=[],s=[],r={price:32,premiumArticlesLimit:3,freeQuizzesLimit:2,freeQuizValueCap:50,articleDiscountPercent:30,quizFreeAccess:!1,quizDiscountPercent:20,discountedQuizzesLimit:3},o={quiz:50,article:50};function a(e){let t={id:D(),email:e,likedArticles:[],userDiscounts:[]};return s.push(t),t}function u(e){return s.find(t=>t.email===e)}function l(e){let t=u(e)||a(e),i={id:D(),userId:t.id,email:e,plan:"premium",status:"active",startDate:new Date,endDate:new Date(Date.now()+2592e6),price:r.price,premiumArticlesUsed:0,premiumArticlesLimit:r.premiumArticlesLimit,freeQuizzesUsed:0,freeQuizzesLimit:r.freeQuizzesLimit,freeQuizValueCap:r.freeQuizValueCap,articleDiscountPercent:r.articleDiscountPercent,quizFreeAccess:r.quizFreeAccess,quizDiscountPercent:r.quizDiscountPercent,discountedQuizzesUsed:0,discountedQuizzesLimit:r.discountedQuizzesLimit,manualDiscounts:[],lastCycleReset:new Date};return n.push(i),t.subscription=i,i}function c(e){let t=n.find(t=>t.email===e&&"active"===t.status);return t&&function(e){var t;let i=new Date;t=e.lastCycleReset,(i.getUTCFullYear()!==t.getUTCFullYear()||i.getUTCMonth()!==t.getUTCMonth())&&(e.premiumArticlesUsed=0,e.freeQuizzesUsed=0,e.discountedQuizzesUsed=0,e.lastCycleReset=i,e.endDate<i&&(e.endDate=new Date(i.getTime()+2592e6)))}(t),t}function d(e){let t=c(e);return!!t&&t.endDate>new Date}function m(e){let t=c(e);return!!t&&t.premiumArticlesUsed<t.premiumArticlesLimit}function h(e){let t=c(e);return!!(t&&m(e))&&(t.premiumArticlesUsed+=1,!0)}function p(e,t){let i=c(e);return i?m(e)?0:Math.round(t*(1-i.articleDiscountPercent/100)*100)/100:null}function g(e,t){let i=c(e);return!!i&&(!!i.quizFreeAccess||i.freeQuizzesUsed<i.freeQuizzesLimit&&t<=i.freeQuizValueCap)}function y(e,t){let i=c(e);return i?g(e,t)?0:i.discountedQuizzesUsed<i.discountedQuizzesLimit?Math.round(t*(1-i.quizDiscountPercent/100)*100)/100:t:null}function f(e){let t=c(e);return!!t&&t.discountedQuizzesUsed<t.discountedQuizzesLimit&&(t.discountedQuizzesUsed+=1,!0)}function z(e){let t=c(e);return!!t&&(!!t.quizFreeAccess||t.freeQuizzesUsed<t.freeQuizzesLimit&&(t.freeQuizzesUsed+=1,!0))}function v(e,t){let i=u(e)||a(e);return!i.likedArticles.includes(t)&&(i.likedArticles.push(t),!0)}function w(e,t){let i=u(e);if(!i)return!1;let n=i.likedArticles.indexOf(t);return n>-1&&(i.likedArticles.splice(n,1),!0)}function b(e,t){let i=u(e);return!!i&&i.likedArticles.includes(t)}function A(e){let t=c(e);return t?{plan:t.plan,status:t.status,premiumArticlesUsed:t.premiumArticlesUsed,premiumArticlesRemaining:t.premiumArticlesLimit-t.premiumArticlesUsed,freeQuizzesUsed:t.freeQuizzesUsed,freeQuizzesRemaining:t.freeQuizzesLimit-t.freeQuizzesUsed,freeQuizValueCap:t.freeQuizValueCap,discountedQuizzesUsed:t.discountedQuizzesUsed,discountedQuizzesRemaining:t.discountedQuizzesLimit-t.discountedQuizzesUsed,endDate:t.endDate,daysRemaining:Math.ceil((t.endDate.getTime()-Date.now())/864e5)}:null}function k(e){let t=n.find(t=>t.email===e&&"active"===t.status);return!!t&&(t.status="cancelled",t.endDate=new Date,!0)}function P(e){let t=c(e);return!!t&&(t.premiumArticlesUsed=0,t.freeQuizzesUsed=0,t.discountedQuizzesUsed=0,t.lastCycleReset=new Date,!0)}function D(){return Math.random().toString(36).substr(2,9)}function x(e,t,i){let n=o[t],s=c(e);if(s){if("quiz"===t&&(s.quizFreeAccess||s.freeQuizzesUsed<s.freeQuizzesLimit&&n<=s.freeQuizValueCap))return 0;if("quiz"===t&&s.discountedQuizzesUsed<s.discountedQuizzesLimit)return Math.round(n*(1-s.quizDiscountPercent/100)*100)/100;if("article"===t&&m(e))return 0;if("article"===t)return Math.round(n*(1-s.articleDiscountPercent/100)*100)/100}let r=u(e);if(r){let e=r.userDiscounts.filter(e=>e.itemType===t&&(!e.itemId||e.itemId===i));if(e.length>0)return e.reduce((e,t)=>t.discountedPrice<e.discountedPrice?t:e).discountedPrice}return n}}};var t=require("../../../../webpack-runtime.js");t.C(e);var i=e=>t(t.s=e),n=t.X(0,[8948,5972],()=>i(53379));module.exports=n})();
...
export default function QuizzesIndexPage() {
  const quizzes = loadAllQuizzes().filter(q => q.published !== false);
  return (
          ...
          <div className="text-center mb-16 animate-fade-in">
            ...
            <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-2xl mx-auto">
              <div className="text-center group">
                <div className="text-3xl font-bold text-primary group-hover:scale-110 transition-transform duration-200">{quizzes.length}</div>

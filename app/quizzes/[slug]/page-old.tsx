...
export async function generateMetadata({ params }: { params: { slug: string } }): Promise<Metadata> {
  ...
  return {
    title,
    description,
    alternates: { canonical: url, languages: { 'en-IN': url, 'en-US': url, 'x-default': url } },
    robots: quiz.robots,
  ...
  return (
    <ErrorBoundary>
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-purple-50 relative overflow-hidden">
        {/* No top ads - keeping quiz experience clean */}
        ...
        <Container>
          <section className="relative py-16">
            ...
            {/* No bottom ads - keeping quiz experience clean */}
          </section>
        </Container>
      </div>
    </ErrorBoundary>

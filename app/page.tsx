...
import { BookOpen, ListChecks, FlaskConical, Users, TrendingUp, Sparkles, Brain, Search, Lightbulb, BookOpenCheck } from 'lucide-react';
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4 mb-12">
                <Button size="lg" className="bg-purple-600 hover:bg-purple-700 text-white px-8 py-3 text-lg font-semibold rounded-full" asChild>
                  <Link href="/quizzes">Start Your Journey</Link>
                </Button>
                <Button size="lg" variant="outline" className="border-gray-300 text-gray-700 hover:bg-white/50 px-8 py-3 text-lg rounded-full" asChild>
                  <Link href="/blog">Explore Insights</Link>
                </Button>
              </div>
            </motion.div>
            
            {/* Right Visual - Meditation Figure with Floating Icons */}
            <motion.div
            ...
            >
              ...
              <div className="relative">
                {/* Replace this div with your actual image once you add it to public/images/ */}
                <div className="w-80 h-80 relative">
                  {/* Placeholder for your meditation image - replace with actual image */}
                  <div className="w-full h-full bg-gradient-to-br from-purple-400/30 via-yellow-300/40 to-purple-500/30 rounded-full flex items-center justify-center shadow-2xl backdrop-blur-sm border border-white/20">
                    <div className="text-center text-gray-700">
                      <div className="text-sm mb-2">Add your meditation image to:</div>
                      <div className="text-xs font-mono bg-white/50 px-2 py-1 rounded">
                        /public/images/meditation-figure.png
                      </div>
                    </div>
                  </div>
                  
                  {/* Once you add the image, uncomment this and remove the placeholder above:
                  <Image
                ...
                {/* Floating icons around the figure */}
                <motion.div
                  animate={{ 
                    y: [0, -10, 0],
                    rotate: [0, 5, 0]
        ...
        <div className="mx-auto max-w-6xl px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Take research-backed assessments to understand yourself better. Get personalized insights and actionable guidance.
            </p>
          </motion.div>
              ...
              >
                ...
                <Button className="w-full bg-purple-600 hover:bg-purple-700" asChild>
                  <Link href={`/quiz/${quiz.slug}`}>
                    Take Assessment <TrendingUp className="w-4 h-4 ml-2" />
                  </Link>
                </Button>
              </motion.div>
            ))}

    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div className="md:col-span-2">
        ...
        <textarea
          ...
          placeholder="Edit quiz JSON..."
        />
        <p className="text-xs text-gray-500 mt-2">Tip: Add questions[] and bands[]. Use published=true to publish. Set isPaid/price for paywall later.</p>
      </div>
    </div>
  );
}
